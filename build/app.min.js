...
var onRegFrmSubmit = function () {
    $("#registerForm").validate({
      rules: {
        ...
        repeat_pwd: { required: !0, equalTo: "#pwd2" },
      },
      messages: {
        username: {
  ...
  onLoginFrmSubmitMain = function () {
    $("#loginForm-main").validate({
      rules: {
        username: {
          required: !0,
          minlength: 6,
...
function receiveMessage(a) {
  void 0 !== a.data.session_id && onLoginFbSucceed(a.data.session_id);
}
window.addEventListener("message", receiveMessage, !1),
  $(document).ready(function () {
    $(".wrap-form-center").click(function () {
      0 == $("body").hasClass("style-mb") && $("#formmodal").modal();
    }),
      ...
      $(".slick-game-mb").slick({
        ...
        responsive: [
          ...
          {
            breakpoint: 640,
            settings: { slidesToShow: 2, centerMode: !0, centerPadding: "15%" },
          },
        ],
      }),
      $(".game-slick").slick({
      ...
      $(document).on("click", ".adv", function (a) {
        /android/i.test(userAgent) && isCHPlay && onDownloadAndroid(),
          ((/iPad|iPhone|iPod/.test(userAgent) &&
            !window.MSStream &&
            isAppStore) ||
            (isIPadPro && isAppStore)) &&
            onDownloadIOS();
      }),
      ...
      setTimeout(function () {
        Fingerprint2.get(function (a) {
          var e = a.map(function (a) {
            ...
            n = Fingerprint2.x64hash128(e.join(""), 31);
          $("input[name='fg']").val(n);
        });
      }, 500);
    var a = new UAParser();
    a.setUA(userAgent);
    var e = a.getResult();
    $("input[name='browser']").val(e.browser.name),
      $("input[name='os']").val(e.os.name),
      $("input[name='device']").val(
        null == e.device.vendor
          ? "Desktop"
          : e.device.vendor + " " + e.device.model
      ),
      $("input[name='aff_id']").val(aff_id),
      $("input[name='app_id']").val(app_id);
    var n = new URLSearchParams(window.location.search),
      o = n.get("utm_source"),
      t = n.get("utm_campaign"),
      i = n.get("utm_content"),
      s = n.get("utm_medium"),
      l = n.get("utm_term");
    return (
      $("input[name='utm_source']").val(o),
      $("input[name='utm_campaign']").val(t),
      $("input[name='utm_content']").val(i),
      $("input[name='utm_medium']").val(s),
      $("input[name='utm_term']").val(l),
      $("#form .nav-tabs a").on("click", function (a) {
        $("#form .nav-tabs").removeClass("tabs-active"),
          setTimeout(function () {
            $("#form .nav-tabs > li").removeClass("active"),
              $("#form .nav-tabs > li:has(> a.active)").addClass("active");
          }, 100);
      }),
      $(".player .nav-tabs a").on("click", function (a) {
          ...
          .on("change focus", function (a) {
            setTimeout(function () {
              $.each(
                ...
                function () {
                  var a = $(this).clone(!0, !0);
                  $(this).after(a).remove(), updateActions();
                }
              );
            }, 50);
          })
      ...
      /windows phone/i.test(userAgent)
        ? ($(".adv, #playvideo-pc").hide(),
          $(".tab-content #register-main").addClass("in active show"),
          $("a.icon-livechat, a.icon-phone").addClass("mb"),
          void (isMobile = !0))
        : /android/i.test(userAgent)
        ? ($("body").addClass("style-mb"),
          (showModalForm = !0),
          $("#playvideo-pc,#ioshd.huongdan_content").hide(),
          $(
            "#main, #android, #playonweb, .hoac,#btn1111,#androidhd.huongdan_content"
          ).show(),
          $("a.icon-livechat, a.icon-phone").addClass("mb"),
          $(".tab-content #register-main").addClass("in active show"),
          $(".menu_close").click(function (a) {
            a.preventDefault(), $(".menu").css("left", "-210px");
          }),
          $(document).on("click", ".dlapp", function (a) {
            a.stopPropagation(), onDownloadAndroid();
          }),
          (isMobile = !0),
          void (isApk && ($("#huongdan").show(), $("body").addClass("bgfull"))))
        : (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) || isIPadPro
        ? ($("body").addClass("style-mb"),
          (showModalForm = !0),
          $("#playvideo-pc,#androidhd.huongdan_content").hide(),
          $(
            "#main, #ios, #playonweb, .hoac,#btn1111,#ioshd.huongdan_content"
          ).show(),
          $("a.icon-livechat, a.icon-phone").addClass("mb"),
          $(".tab-content #register-main").addClass("in active show"),
          $(".menu_close").click(function (a) {
          ...
          $(document).on("click", ".dlapp", function (a) {
            a.stopPropagation(), onDownloadIos();
          }),
          (isMobile = !0),
          void (isIpa && ($("#huongdan").show(), $("body").addClass("bgfull"))))
        : (showModalForm || $("#formmodal").modal("show"),
          $(".sticky-qrcode").show(),
          void $(".tab-content #register-main").addClass("in active show"))
    );
  });
var updateActions = function () {},
  ...
  lazyLoading = function () {
    $("body")
      .find("[data-src]")
      .each(function (a, e) {
        var n = $(e).attr("data-src") + "?v=" + v,
          o = new Image();
        $(o).bind("load error", function () {
          $(e).attr("src", n);
        }),
          (o.src = n);
      });
  },
  onPlayWeb = function (a) {
    if (null == sessionId)
      return (
        $(a).parent().hide(),
        $("#form").addClass("choinhanh"),
        $("#main").addClass("playweb_main"),
        $(".nav-tabs").addClass("tabs-active"),
        $("#form, #games").show(),
        $(".adv, #playonweb, .dacotaikhoan, .hoac").hide(),
        $(".nav-tabs #register-main-tab").removeClass("show active"),
        $(".nav-tabs #login-main-tab").addClass("show active"),
        $(".tab-content #login-main").addClass("in active show"),
        $(".tab-content #register-main").removeClass("in active show"),
        $(".nav-tabs > li").removeClass("active"),
        void $(".nav-tabs > li:has(> a.active)").addClass("active")
      );
  ...
  onLogin = function () {
    $.ajax({
      ...
      success: function (a, e) {
        $(".loading").hide(),
          setCookiesTracking(),
          200 == a.code && "OK" == a.status
            ? ("undefined" != typeof dataLayer &&
                (dataLayer.push({
                  event: "formSubmitted",
                  formName: "Form_Login",
                }),
                dataLayer.push({ event: "formLogin", formName: "Form_Login" })),
              ...
              (window.location.href =
                ...
                aff_id))
            : ($("#formmodal").modal("hide"),
              $("#alertModal .modal-body").html(a.message),
              $("#alertModal").modal());
      },
  ...
  onLoginFB = function () {
    let a = ($(window).height() - 730) / 2,
      e = ($(window).width() - 800) / 2;
    window.open(
      "https://" + conf.fb + "?a=" + aff_id,
      "_blank",
      "width=800,height=730,left=" + e + ",top=" + a
    );
  },
  onLoginFbSucceed = function (a) {
    "undefined" != typeof dataLayer &&
      dataLayer.push({ event: "formSubmitted", formName: "Register_Facebook" }),
      (window.location.href =
        "https://" + conf.wg + "?sessionid=" + a + "&a=" + aff_id);
  },
  onRegister = function () {
    $.ajax({
      url: "/register.html",
      ...
      success: function (a, e) {
        if (
          ...
          $("#formmodal #usrname2").val(), $("#formmodal #pwd2").val();
          (sessionId = a.session_id),
            $("#formmodal").modal("hide"),
            (window.location.href =
              "https://" +
      ...
      success: function (a, e) {
        if (
          ...
          "undefined" != typeof dataLayer &&
            ...
            "undefined" != typeof _mgq &&
              _mgq.push(["MgSensorInvoke", "DangKy"]);
          $(".regFrm-main #usrname").val(), $(".regFrm-main #pwd").val();
          (sessionId = a.session_id),
            $("#formmodal").modal("hide"),
            (window.location.href =
              "https://" +
  ...
  onDownloadAndroid = function () {
    (window.location.href =
      "https://" + conf.dl + "/android.html?t=" + Date.parse(new Date())),
      isApk &&
        setTimeout(function () {
  ...
  onDownloadIos = function () {
    (window.location.href =
      "https://" + conf.dl + "/caidat.php?t=" + Date.parse(new Date())),
      isIpa &&
        setTimeout(function () {
          jQuery("html, body").animate(
            { scrollTop: jQuery("#huongdan").offset().top },
  ...
  showInfo = function (a) {
    $(a).hide(), $("#info").removeClass("d-none");
  },
  setCookiesTracking = function () {
    $.ajax({
      url: "https://" + conf.logip + "/sw/collect?aff_id=" + aff_id,
      dataType: "json",
      success: function (a, e) {},
      error: function (a, e, n) {},
    });
  ...
  setCookiesLogIpv4 = function () {
    $.ajax({
      url: "https://ipv4." + conf.logip + "/sw/collect?aff_id=" + aff_id,
      dataType: "json",
      success: function (a, e) {},
      error: function (a, e, n) {},
    });
  ...
  setCookiesLogIpv6 = function () {
    $.ajax({
      url: "https://ipv6." + conf.logip + "/sw/collect?aff_id=" + aff_id,
      dataType: "json",
      success: function (a, e) {},
      error: function (a, e, n) {},
    });
  ...
  onJackpot = function (a) {
    function e(e, n) {
      a
        ? e.attr("v", n).text(Math.ceil(n).toLocaleString())
        : e.each(function () {
            var a = $(this).attr("v");
            $(this)
              .prop("Counter", a)
              .animate(
                { Counter: n },
                {
                  ...
                  easing: "swing",
                  step: function (a) {
                    $(this).text(Math.ceil(a).toLocaleString());
                  },
                },
                function () {
                  $(this).attr("v", n);
    ...
    $.ajax({
      ...
      success: function (a, n) {
        if (200 == a.code && "OK" == a.status) {
          var o = a.data.length ? a.data[0] : [];
          if (o.vg_jackpots) {
            var t = o.vg_jackpots[18].J;
            e($(".taixiu"), t);
          }
          if (o.vg_jackpots) {
            t = o.vg_jackpots[19].J;
            e($(".baucua"), t);
          }
        }
      },
      ...
      $.ajax({
        ...
        success: function (a, e) {
          ...
          $(".rank-custom ul li")
            .eq(0)
            .find(".name-rank span")
            .html(n[0].fullname.slice(0, 3) + "********"),
            $(".rank-custom ul li")
              .eq(1)
              .find(".name-rank span")
              .html(n[1].fullname.slice(0, 3) + "********"),
            $(".rank-custom ul li")
              .eq(2)
              .find(".name-rank span")
              .html(n[2].fullname.slice(0, 3) + "********"),
            $(".rank-custom ul li")
              .eq(6)
              .find(".name-rank span")
              .html(n[0].fullname.slice(0, 3) + "********"),
            ...
            $(".rank-custom ul li")
              .eq(0)
              .find(".money-rank span")
              .html(n[0].total.toLocaleString()),
            $(".rank-custom ul li")
              .eq(1)
              .find(".money-rank span")
              .html(n[1].total.toLocaleString()),
            $(".rank-custom ul li")
              .eq(2)
              .find(".money-rank span")
              .html(n[2].total.toLocaleString()),
            $(".rank-custom ul li")
              .eq(6)
              .find(".money-rank span")
              .html(n[0].total.toLocaleString()),
